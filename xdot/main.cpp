...
/////////////////////////////////////////////////////////////
static std::string network_name = "got6got6got6";
static std::string network_passphrase = "jynjynjyn";
...
//DigitalIn sensor(PB_0, PullDown);
DigitalOut led(LED1);
DigitalIn sensor(GPIO1, PullDown);
//DigitalOut vcc(GPIO1);
...
//        uint16_t light;
        ...
        val = sensor.read();
        printf("%d\n",val);
        snprintf(out, 5, "%d", val);
        led = val;
        wait(0.5);
        //thread_sleep_for(500);
        printf("What's in out: %s\n", out);
        if (val != prev){
            prev = val;
